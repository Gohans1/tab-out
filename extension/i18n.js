...
(function (global) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'modal.settings.api_key_help': 'Uses OpenRouter to automatically categorize open tabs. If empty or offline, fast local rules are used instantly without sending data externally.',
      ...
      'telemetry.status_openrouter': 'AI classification active',
    ...
    vi: {
      ...
      'modal.settings.api_key_help': 'Sử dụng OpenRouter để tự động phân loại tab. Nếu để trống hoặc ngoại tuyến, quy tắc cục bộ sẽ được dùng ngay trên máy mà không gửi dữ liệu ra ngoài.',
      ...
      'telemetry.status_openrouter': 'Phân loại AI đang hoạt động',
