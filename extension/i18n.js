...
(function (global) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'modal.settings.api_key_placeholder': 'sk-or-v1-... (required for custom perspectives)',
      'modal.settings.api_key_help': 'Uses OpenRouter (Model Jev) to categorize open tabs under custom perspectives. Without an API key, Tab Out organizes tabs cleanly by Domain.',
    ...
    vi: {
      ...
      'modal.settings.api_key_placeholder': 'sk-or-v1-... (cần thiết để dùng góc nhìn tùy chỉnh)',
      'modal.settings.api_key_help': 'Sử dụng OpenRouter (Model Jev) để phân loại thẻ theo các góc nhìn. Khi không có API key, Tab Out sẽ sắp xếp thẻ gọn gàng theo Tên miền (Domain).',
