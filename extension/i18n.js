...
(function (global) {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'banner.dupe_prefix': 'You have',
      'banner.dupe_suffix': 'Tab Out tabs open',
      ...
      'rail.priority_default': 'Priority',
      ...
      'tabs.open_tabs_count_single': '1 open tab',
      'tabs.open_tabs_count_plural': '{count} open tabs',
      'tabs.all_closed_title': 'All tabs closed',
      'tabs.all_closed_desc': 'Clean workspace',
      'tabs.all_categories': 'All',
      'tabs.all_categories_title': 'View all categories (Esc)',
      'tabs.back_to_all': 'Back to all categories',
      'tabs.category_focus_subtitle': 'Focused view for this category',
      'tabs.close_category_tabs': 'Close all in category',
      'tabs.empty_category_title': 'No open tabs',
      'tabs.empty_category_desc': 'There are currently no open tabs in this category.',
      'tabs.more_empty_categories': '+ {count} more',
      'tabs.less_categories': '- Less',
      'tabs.toggle_empty_categories_title': 'Toggle empty categories',
      ...
      'tabs.close_single_tab': 'Close tab',
      'tabs.close_single_tab_confirm': 'Close tab?',
      ...
      'saved.empty_hint': 'Click the save icon on any tab to keep it here for later',
      ...
      'modal.perspective.template_label': 'Start with template:',
      'modal.perspective.template_topic': '+ Topic',
      'modal.perspective.template_purpose': '+ Purpose',
      'modal.perspective.template_priority': '+ Priority',
      'modal.perspective.tags_label': 'Tags & Classification Rules',
      'modal.perspective.tags_hint': 'Each tag has a name and optional description for automatic classification',
      'modal.perspective.add_tag': 'Add tag',
      'modal.perspective.tag_name_placeholder': 'e.g. Work, Research',
      'modal.perspective.tag_instruct_placeholder': 'Instructions for AI classification (optional)',
      ...
      'modal.perspective.delete_desc': 'All custom tags and classification data for this perspective will be permanently removed from your browser.',
      ...
      'modal.settings.api_key_label': 'OpenRouter API Key (Model Jev)',
      'modal.settings.api_key_placeholder': 'sk-or-v1-... (required for Jev AI perspectives)',
      'modal.settings.api_key_help': 'Tab Out uses Model Jev via OpenRouter as its core intelligence engine to categorize open tabs into smart perspectives.',
      ...
      'toast.perspective_created_inactive': 'Perspective saved (locked until API key configured)',
      ...
      // Telemetry
      'telemetry.status_active': 'AI classification active',
      'telemetry.status_inactive': 'AI Inactive',
      'telemetry.status_inactive_tooltip': 'OpenRouter API key required to activate AI perspectives',
      'telemetry.status_offline': 'Classification offline',
      'telemetry.status_openrouter': 'AI classification active (Model Jev)',
      'telemetry.status_auth_error_label': 'API Key Issue',
      'telemetry.status_auth_error': 'OpenRouter API key invalid or restricted',
      'telemetry.loading': 'AI is classifying open tabs...',
      'rail.perspective_locked_tooltip': 'Requires OpenRouter API key (Model Jev)',
      'perspective.ai_required_toast': 'OpenRouter API key required to activate AI perspectives',
    ...
    vi: {
      ...
      // Theme
      'theme.toggle_light': 'Chuyển sang giao diện sáng',
      'theme.toggle_dark': 'Chuyển sang giao diện tối',
      'theme.dark': 'Tối',
      'theme.light': 'Sáng',

      // Dupe Banner
      'banner.dupe_count': 'Bạn đang mở {count} thẻ Tab Out',
      'banner.dupe_prefix': 'Bạn đang mở',
      'banner.dupe_suffix': 'thẻ Tab Out',
      'banner.close_extras': 'Đóng các thẻ thừa',
      ...
      'tabs.open_tabs_count_single': '1 thẻ đang mở',
      'tabs.open_tabs_count_plural': '{count} thẻ đang mở',
      'tabs.all_closed_title': 'Đã đóng hết các thẻ',
      'tabs.all_closed_desc': 'Không gian làm việc gọn gàng',
      'tabs.all_categories': 'Tất cả',
      'tabs.all_categories_title': 'Xem tất cả danh mục (Esc)',
      'tabs.back_to_all': 'Quay lại tất cả danh mục',
      'tabs.category_focus_subtitle': 'Chế độ tập trung cho danh mục này',
      'tabs.close_category_tabs': 'Đóng tất cả trong danh mục',
      'tabs.empty_category_title': 'Không có thẻ nào',
      'tabs.empty_category_desc': 'Hiện tại không có thẻ nào đang mở trong danh mục này.',
      'tabs.more_empty_categories': '+ {count} rỗng',
      'tabs.less_categories': '- Thu gọn',
      'tabs.toggle_empty_categories_title': 'Bật/tắt danh mục rỗng',
      ...
      'tabs.close_single_tab': 'Đóng thẻ',
      'tabs.close_single_tab_confirm': 'Đóng thẻ?',
      'tabs.close_group_confirm': 'Đóng {count} thẻ?',
      'tabs.close_dupes': 'Đóng {count} thẻ trùng',
      'tabs.edit_tags': 'Chỉnh sửa nhãn',
      ...
      'chip.recent': 'Vừa xem',
      'chip.recent_title': 'Thẻ vừa xem gần nhất',
      'chip.save_for_later': 'Lưu lại',
      ...
      // Saved for Later / Archive (Right column)
      'saved.title': 'Đã lưu',
      'saved.empty_title': 'Chưa có thẻ nào được lưu',
      'saved.empty_hint': 'Bấm biểu tượng lưu trên thẻ để cất vào đây xem lại sau',
      ...
      // Modals
      'modal.perspective.title_new': 'Tạo góc nhìn mới',
      'modal.perspective.title_edit': 'Chỉnh sửa góc nhìn: {name}',
      'modal.perspective.name_label': 'Tên góc nhìn',
      'modal.perspective.name_placeholder': 'ví dụ: Dự án, Ưu tiên, Đọc dở',
      'modal.perspective.template_label': 'Bắt đầu nhanh với mẫu:',
      'modal.perspective.template_topic': '+ Chủ đề',
      'modal.perspective.template_purpose': '+ Mục đích',
      'modal.perspective.template_priority': '+ Ưu tiên',
      'modal.perspective.tags_label': 'Danh sách nhãn & Quy tắc phân loại',
      'modal.perspective.tags_hint': 'Mỗi nhãn có tên và mô tả tùy chọn để AI tự động phân loại chuẩn xác',
      'modal.perspective.add_tag': 'Thêm nhãn',
      'modal.perspective.tag_name_placeholder': 'vd: Công việc, Dự án',
      'modal.perspective.tag_instruct_placeholder': 'Mô tả cho AI phân loại (tùy chọn)',
      'modal.perspective.drag_tag': 'Kéo hoặc dùng phím mũi tên để sắp xếp nhãn',
      'modal.perspective.tag_color': 'Chọn màu nhãn',
      'modal.perspective.delete_tag': 'Xóa nhãn',
      'modal.perspective.swatch_none': 'Mặc định (không màu)',
      'modal.perspective.fallback_hint': 'Nhãn "Khác" là mặc định cho mọi thẻ chưa phân loại (hệ thống tự quản lý, không thể xóa).',
      'modal.perspective.delete': 'Xóa',
      'modal.perspective.delete_title': 'Xóa góc nhìn "{name}"?',
      'modal.perspective.delete_desc': 'Toàn bộ nhãn tùy chỉnh và dữ liệu phân loại của góc nhìn này sẽ bị xóa vĩnh viễn khỏi trình duyệt.',
      ...
      'modal.settings.language_en': 'English',
      'modal.settings.language_vi': 'Tiếng Việt',
      'modal.settings.api_key_label': 'Khóa API OpenRouter (Model Jev)',
      'modal.settings.api_key_placeholder': 'sk-or-v1-... (cần thiết cho góc nhìn AI Model Jev)',
      'modal.settings.api_key_help': 'Tab Out sử dụng Model Jev qua OpenRouter làm engine cốt lõi để phân loại thẻ vào các góc nhìn thông minh.',
      ...
      'toast.perspective_created': 'Góc nhìn đã được tạo & áp dụng',
      'toast.perspective_created_inactive': 'Đã lưu góc nhìn (sẽ mở khóa khi thêm API key OpenRouter)',
      'toast.perspective_updated': 'Góc nhìn đã được cập nhật',
      'toast.perspective_deleted': 'Đã xóa góc nhìn',
      'toast.tags_reset': 'Đã khôi phục danh sách nhãn mặc định',
      'toast.enter_perspective_name': 'Vui lòng nhập tên góc nhìn',
      'toast.add_at_least_one_tag': 'Vui lòng thêm ít nhất 1 nhãn',
      'toast.saved_for_later': 'Đã lưu',
      'toast.all_tabs_closed': 'Đã đóng tất cả thẻ. Bắt đầu mới.',
      'toast.closed_extras': 'Đã đóng các thẻ Tab Out thừa',
      ...
      // Telemetry
      'telemetry.status_active': 'Phân loại AI đang hoạt động',
      'telemetry.status_inactive': 'Chưa kích hoạt AI',
      'telemetry.status_inactive_tooltip': 'Cần API key OpenRouter để bật các góc nhìn AI',
      'telemetry.status_offline': 'Phân loại ngoại tuyến',
      'telemetry.status_openrouter': 'Phân loại AI đang hoạt động (Model Jev)',
      'telemetry.status_auth_error_label': 'Lỗi API Key',
      'telemetry.status_auth_error': 'API key OpenRouter không hợp lệ hoặc bị hạn chế',
      'telemetry.loading': 'AI đang phân loại các thẻ đang mở...',
      'rail.perspective_locked_tooltip': 'Cần API key OpenRouter (Model Jev)',
      'perspective.ai_required_toast': 'Cần API key OpenRouter để kích hoạt góc nhìn này',
